...
const utilityButtons: ButtonSpec[] = [
	...
	{ kind: "command", id: "pdiff", label: " PDIFF ", command: "/pdiff", palette: "warning" },
	...
	{ kind: "action", id: "next-terminal-tab", label: "► TAB", action: "nextTerminalTab", palette: "accent" },
	{ kind: "action", id: "prev-terminal-tab", label: "◄ TAB", action: "prevTerminalTab", palette: "accent" },
];
...
export function getViewMenuButtons(shell: ShellModeState): ButtonSpec[] {
	...
	return [
		...
		{ kind: "action", id: "view-scroll-dir", label: shell.viewportScrollDirectionInverted ? " INV " : " NAT ", action: "toggleViewportScrollDirection", palette: shell.viewportScrollDirectionInverted ? on : off },
